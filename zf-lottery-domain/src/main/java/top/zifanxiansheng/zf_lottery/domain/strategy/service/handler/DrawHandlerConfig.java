...
public class DrawHandlerConfig implements ApplicationContextAware {
    ...
    protected static final Map<Integer, LotteryAlgorithm> LOTTERY_ALGORITHM_MAP = new ConcurrentHashMap<>();
    ...
    public void init() {
        ...
        beansMap.entrySet().forEach(beanEntry -> {
            ...
            if (beanEntry.getValue() instanceof LotteryAlgorithm)
                LOTTERY_ALGORITHM_MAP.put(strategyModel.strategyModel().getCode(), (LotteryAlgorithm) beanEntry.getValue());
